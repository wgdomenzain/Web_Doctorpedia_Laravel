...
<body>
    <header id="header-menu">
        <div id="header-title" class="left">Doctorpedia</div>
        <div class="left">{{Session::get('msg_error')}}</div>
        <nav id="nav-menu" class="align-right">
            <ul>
                <li class="nav-menu-option"><a href="{{asset('')}}">Búsqueda</a></li>
                @if(Session::get('id') != '')
                    @if(Session::get('profile')=='doctor')<li class="nav-menu-option"><a href="{{asset('appointments')}}">Citas</a></li>@endif
                    @if(Session::get('profile')=='patient')<li class="nav-menu-option"><a href="{{asset('appointments_patient')}}">Citas</a></li>@endif
                    <li class="nav-menu-option"><a href="{{asset('messages')}}">Mensajes</a></li>
                    <li class="nav-menu-option">
                        <div id="session" class="">
                            <a href="@if(Session::get('profile') == 'doctor'){{asset('profile')}} @elseif(Session::get('profile') == 'patient') {{asset('profile_patient')}} @endif">
                                <div class="color_white inline">{{Session::get('name')}}</div>
                                <div id="div-session-photo" class="inline"><img id="session-photo" src="{{asset('resources/img/session/'.Session::get('photo'))}}"></div>
                            </a>
                            <div id="flecha_sesion" class="arrow-up"></div>
                        </div>
                    </li>
                @else
                    <li class="nav-menu-option"><nav id="nav-home">
                        ...
                        <div class="form hide">
                            <div class="div-form-button">
                                ...
                                <div id="sign-Paciente-form" class="form-block" data-block="sign">
                                    <form action="{{asset('PRegister')}}" method="post" enctype="multipart/form-data" accept-charset="UTF-8" class="align-center">
                                        {{Form::token();}}
                                ...
                                <form id="sign-serialize" action="{{asset('DRegister')}}" method="post" enctype="multipart/form-data" accept-charset="UTF-8" class="align-center">
                                    {{Form::token();}}
                                            ...
                                            <div>
                                                ...
                                                <div class="align-left">
                                                    <dl class="dropdown"> 
                                                        ...
                                                        <dd>
                                                            <div class="mutliSelect">
                                                                <ul id="especialidades" class="ul-cerca align-left">
                                                    ...
                                                    <dl class="dropdown"> 
                                                        ...
                                                        <dd>
                                                            <div class="mutliSelect">
                                                                <ul id="aseguradoras" class="ul-cerca align-left">
                                                    ...
                                                    <dl class="dropdown"> 
                                                        ...
                                                        <dd>
                                                            <div class="mutliSelect">
                                                                <ul id="idiomas" class="ul-cerca align-left">
                                ...
                                <form action="{{asset('DRegister_schedule')}}" method="post" accept-charset="UTF-8" class="align-center">
                                    {{Form::token();}}
                        ...
                        <div class="form hide small-form">
                            <div class="div-form-button">
                                ...
                                <div id="log-Paciente-form" class="form-block" data-block="log">
                                    <form action="{{asset('PLogin')}}" method="post" accept-charset="UTF-8" class="align-center">
                                        {{Form::token();}}
                                        <div class="block-form-home">
                                            <div class="block-form-title">
                                                Paciente
                                            ...
                                            <div>
                                                <input name="email" class="required align-center" type="email" placeholder="Correo electrónico">
                                                <input name="password" class="required align-center" type="password" placeholder="Contraseña">
                                            </div>
                                        </div>
                                ...
                                <div id="log-Doctor-form" class="form-block hide" data-block="log">
                                    <form action="{{asset('DLogin')}}" method="post" accept-charset="UTF-8" class="align-center">
                                        {{Form::token();}}
                                        <div class="block-form-home">
                                            <div class="block-form-title">
                                                Doctor
    ...
    <script type="text/javascript"> var profile = '{{Session::get("profile")}}'</script>
